...
public class VictoryMenu extends ALevel {
    ...
    private static final double LABELS_Y = 20.0;
    private static final double BUTTON_Y = 525.0;
    ...
    protected void setup() {
        ...
        // Labels
        Label youWin = LevelUtils.createLabel("You Win!", 300.0, true, 50.0);
        double fixedWidth = 500.0;
        Label message = LevelUtils.createLabel(
                "You have reached the center of the earth! You and Dig Inc. will go down in history!", fixedWidth, true, 16.0);
